...
* For regions of interest, comparing conservation while matching on various characteristics (GC, LDSC, gene density) (Pat Sullivan)
...
```{r fig.dim=c(4,3), out.width="50%", message=FALSE}
sce %>%
